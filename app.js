...
/**
 * Update foto peserta via ImgBB.
 * Foto (blob) di-upload ke ImgBB, URL hasilnya disimpan ke Firestore.
...
async function updateFotoPeserta(id, fotoBlob) {
  // ImgBB menerima file via FormData
  const formData = new FormData();
  formData.append('image', fotoBlob);
  ...
  const url = data.data.url; // URL foto hasil upload
